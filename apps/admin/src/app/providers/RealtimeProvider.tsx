...
import { analyticsKeys } from '@erp/store-buddy-view/analytics';
import { inventoryKeys } from '@erp/store-buddy-view/inventory';
import { transferKeys } from '@erp/store-buddy-view/transfer';
