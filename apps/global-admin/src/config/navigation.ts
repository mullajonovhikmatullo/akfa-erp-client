...
export const primaryNavigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: Buildings,
    children: [
      { id: 'companies-overview', label: 'Umumiy ko‘rinish', path: '/companies', icon: Buildings },
      { id: 'companies-new', label: 'Yangi kompaniya', path: '/companies/new', icon: Buildings },
      { id: 'companies-active', label: 'Faol mijozlar', path: '/companies/active', icon: Buildings },
      { id: 'companies-blocked', label: 'Bloklangan mijozlar', path: '/companies/blocked', icon: Buildings },
    ],
  },
  {
    id: 'subscriptions',
    ...
    icon: CreditCard,
    children: [
      { id: 'plans', label: 'Tariflar', path: '/subscriptions/plans', icon: CreditCard },
      { id: 'payments', label: 'To‘lovlar', path: '/subscriptions/payments', icon: Receipt },
      { id: 'debts', label: 'Qarzdorliklar', path: '/subscriptions/debts', icon: Receipt },
      { id: 'renewals', label: 'Yangilanishlar', path: '/subscriptions/renewals', icon: CreditCard },
    ],
  },
  {
    id: 'stores',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    children: [
      { id: 'global-admins', label: 'Global adminlar', path: '/admins/global', icon: ShieldCheck },
