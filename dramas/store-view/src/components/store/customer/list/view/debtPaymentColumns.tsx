...
export function createDebtPaymentColumns(t: StoreTranslator): ColumnDef<DebtPayment>[] {
  //
  return [
    ...
    { title: t('customers.paymentsMethod'), dataIndex: 'paymentMethod', width: 160, render: (method: PaymentMethod) => t(`payment.${method}`) },
