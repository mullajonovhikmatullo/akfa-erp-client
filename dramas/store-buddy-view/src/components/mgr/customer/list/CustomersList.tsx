...
import { getField, isUuid, parseExcelNumber } from '@erp/erp-shared/lib/parse-excel'
...
import { customerApi } from '@erp/store-buddy-stub'
import type { CreateCustomerPayload, Customer } from '@erp/store-buddy-stub'
      ...
      render: (_: unknown, customer: Customer) => {
        ...
        const label =
          customer.balance > 0
            ...
            : customer.balance < 0
              ? t('customers.balanceCredit')
              : t('customers.balanceZero')
        return (
          ...
          {canManage && (
            <>
              ...
              <Popconfirm
                ...
                okButtonProps={{ danger: true, loading: deleteMutation.isPending && deleteMutation.variables === customer.id }}
                onConfirm={(event) => {
                  //
                  event?.stopPropagation()
              ...
              >
                <Button
                  ...
                  loading={deleteMutation.isPending && deleteMutation.variables === customer.id}
