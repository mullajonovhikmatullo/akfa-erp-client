...
import { categoryApi } from '@erp/store-buddy-stub'
import type { CreateCategoryPayload, UpdateCategoryPayload } from '@erp/store-buddy-stub'
        ...
        <Form layout="vertical" autoComplete="off" style={{ marginTop: 16 }}>
          ...
          >
            <Controller
              ...
              render={({ field }) => <Input {...field} {...blockAutofill('akfa-category-name')} placeholder={t('categories.namePlaceholder')} />}
            />
          </Form.Item>
