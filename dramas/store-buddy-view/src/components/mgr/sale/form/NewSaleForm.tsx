...
import { PAYMENT_METHOD_LABELS } from '@erp/erp-shared/core'
import { getSaleProductPrice, getSaleProductPriceUzs } from '@erp/erp-shared/lib/product-pricing'
...
import type { Customer, PaymentMethod, Product, SaleType } from '@erp/store-buddy-stub'
