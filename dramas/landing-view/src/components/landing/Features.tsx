    ...
    return (
        <section className="features-section" id="imkoniyatlar">
            <div className="container-page">
                <div className="section-heading section-heading--center" data-reveal="up"><h2>{t.features.heading}</h2>
                </div>
                    ...
                    {t.features.items.map(({title, text}, index) => {
                        ...
                        return icon ? (
                            <article className="feature-card" key={`feature-${index}`} data-reveal="up">
                                <span className="feature-card__icon"><i
                                    className={`icons-${icon} icon-size-23`}/></span>
                                <h3>{title}</h3>
                                <p>{text}</p>
                            </article>
                        ) : null;
