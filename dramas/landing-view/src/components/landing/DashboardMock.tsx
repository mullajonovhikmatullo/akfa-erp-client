...
const sidebarGroups: ReadonlyArray<{
    ...
    {title: 'warehouse',
        items: [{label: 'categories', icon: 'category'}, {label: 'products', icon: 'unit'}, {
            label: 'transfers',
            icon: 'transfer'
        }]
    },
                ...
                <div className="dashboard-main">
                    ...
                    <div className="dashboard-content">
                        <div className="dashboard-heading">
                            ...
                            <div className="dashboard-heading__actions">
                                <button type="button"><i
                                    className="icons-plus icon-size-11"/>{dashboard.actions.newSale}</button>
                                <button type="button"><i
                                    className="icons-print icon-size-11"/>{dashboard.actions.export}</button>
                                <button type="button"><i
                                    className="icons-reload icon-size-11"/>{dashboard.actions.refresh}</button>
                                <button className="is-primary" type="button"><i
                                    className="icons-chart-bar icon-size-11"/>{dashboard.actions.analysis}</button>
                            </div>
                        </div>
                        ...
                        <div className="dashboard-trial">
                            ...
                            <div><i
                                className="icons-calendar-days icon-size-12"/><span>14.07.2026</span><i/><span>26.07.2026</span>
                            </div>
                        </div>
                        ...
                        <div className="dashboard-analytics">
                            <div className="dashboard-chart-card">
                                <div className="dashboard-card-title"><strong>{dashboard.chartTitle}</strong><span>14.07.2026 – 26.07.2026</span>
                                </div>
                                <div className="dashboard-line-chart">
                                    ...
                                    <svg viewBox="0 0 420 172" role="img" aria-label={dashboard.chartLabel}>
                                        <g className="chart-grid">
                                            ...
                                            <path
                                                d="M75 14V145M130 14V145M185 14V145M240 14V145M295 14V145M350 14V145"/>
                                        </g>
                                        <path className="chart-line chart-line--blue"
                                              d="M20 140 C55 137 65 124 84 124 S118 137 140 130 S177 118 198 112 S229 26 249 26 S275 139 303 131 S335 116 355 112 S389 121 410 105"/>
                                        <path className="chart-line chart-line--orange"
                                              d="M20 141 C57 139 70 118 91 113 S125 137 150 133 S184 121 207 123 S238 104 260 112 S292 134 315 128 S348 107 370 117 S392 129 410 121"/>
                                        <path className="chart-line chart-line--red"
                                              d="M20 143 C61 142 75 134 96 135 S130 142 151 139 S189 128 212 131 S245 119 267 126 S302 139 324 136 S360 125 382 130 S400 137 410 133"/>
                                    </svg>
                                    <div className="dashboard-line-chart__labels">{chartDays.map((day) => <span
                            ...
                            <div className="dashboard-share-card">
                                <div className="dashboard-card-title">
                                    <strong>{dashboard.shareTitle}</strong><span>14.07.2026</span></div>
                                <div className="dashboard-share-card__body">
                                    <div className="dashboard-donut">
                                        <div><span>{dashboard.total}</span><strong>92.8 {dashboard.currency}</strong>
                                        </div>
                                    </div>
                                    <ul>
                                        {branchData.map((branch, index) => (
                                            <li key={branch.color}>
                                                <span
                                                    className={`dashboard-branch-color dashboard-branch-color--${index}`}/>
                                                <div>
                                                    <strong>{dashboard.branches[index]}</strong><small>{branch.value} {dashboard.currency}</small>
                                                </div>
                        ...
                        <div className="dashboard-summary-row">
                            ...
                            <div><span>{dashboard.summary[1]}</span><strong
                                className="is-success">0.0 {dashboard.currency}</strong></div>
