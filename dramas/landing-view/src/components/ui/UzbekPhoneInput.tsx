...
function UzbekistanFlagIcon() {
  return (
    <svg width="20" height="14" viewBox="0 0 20 14" aria-hidden="true">
      ...
      <g fill="#fff">
        <circle cx="6" cy="1.25" r="0.22" /><circle cx="7.1" cy="1.25" r="0.22" /><circle cx="8.2" cy="1.25" r="0.22" />
        <circle cx="6.55" cy="2.2" r="0.22" /><circle cx="7.65" cy="2.2" r="0.22" /><circle cx="8.75" cy="2.2" r="0.22" />
        <circle cx="6" cy="3.15" r="0.22" /><circle cx="7.1" cy="3.15" r="0.22" /><circle cx="8.2" cy="3.15" r="0.22" />
      </g>
    </svg>
  );
}
