...
import type { GlobalAdminProfile } from '../../types/dashboard';

interface GlobalAdminProfileCardProps {
  admin: GlobalAdminProfile;
}

export const GlobalAdminProfileCard = ({ admin }: GlobalAdminProfileCardProps) => (
